...
def go_repositories():
    go_repository(
        ...
        sum = "h1:TOcrF8t0T3I0za9JD3CB6ehq7dDEMjR9Onikf8Lc/04=",
        version = "v0.17.22",
    )
    ...
    go_repository(
        ...
        replace = "github.com/Manbeardo/golang-x-sys",
        sum = "h1:0BZtTqupkOdEkabsPwRScv6nBSqO4D/khH7vthAdlbM=",
        version = "v0.3.0-relative-path",
    )
    go_repository(
